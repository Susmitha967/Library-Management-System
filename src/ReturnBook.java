...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ApiClient.ApiResponse bookRes = ApiClient.get("/api/books/by-student",
                    java.util.Map.of("studentId", txtstudentid.getText()));
            if(bookRes.status() == 200){
                java.util.Map<String, String> kv = ApiClient.parseKeyValueBody(bookRes.body());
                txtbookname.setText(kv.getOrDefault("name", ""));
                txtbookid.setText(kv.getOrDefault("id", ""));
                txtissuedate.setText(kv.getOrDefault("issue", ""));
                txtduedate.setText(kv.getOrDefault("due", ""));
            } else {
                JOptionPane.showMessageDialog(this, "Please Enter Valied Student ID");
                return;
            }

            // student name (keep it simple: show ID if not found)
            txtstudentname.setText(txtstudentid.getText());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(txtbookid.getText().equals("")){
            ...
            try{
            ApiClient.ApiResponse res = ApiClient.postForm("/api/books/return",
                    java.util.Map.of("id", txtbookid.getText()));
            if (res.status() != 200) {
