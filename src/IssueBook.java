...
public void clear(){
    ...
    private void btnissueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnissueActionPerformed
        if(txtid.getText().equals("")){
            ...
            try{
            ApiClient.ApiResponse res = ApiClient.postForm("/api/books/issue", java.util.Map.of(
                    "id", txtid.getText(),
                    "studentId", txtstudentid.getText(),
                    "issue", txtissuedate.getText(),
                    "due", txtduedate.getText()
            ));
            if (res.status() != 200) {
            ...
            clear();
                ...
                JOptionPane.showMessageDialog(this, "Issue failed: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ApiClient.ApiResponse res = ApiClient.get("/api/books", java.util.Map.of("id", txtid.getText()));
            if (res.status() == 200) {
                java.util.Map<String, String> kv = ApiClient.parseKeyValueBody(res.body());
